...
#'
#' Subset data to create a smaller analytic dataset. Keep track of how many
#' observations remain after each sequential subset, as well as how many
#' observations meet the keep criteria overall.
#'
#' @param DT A data.table.
#' @param subset_vars A vector of string column names in DT. Each
#' column should be a dummy variable, with 1 (or TRUE) set as the keep condition
#' and 0 (or FALSE) as the drop condition.
#'
#' @return Subset of DT along with the a table of how many observations remain
#' after each subset (obs_seq) and the number observations that meet the keep
#' criteria overall (obs_cum).
#'
#' @examples
